...
prepare_docker_contents()
{
  ...
  \cp -f "${__CURRENT_DIR}/installation_files/install_ant.sh" "${COMPONENT_DIR}/components"
  record_cleanup "${COMPONENT_DIR}/components/install_ant.sh"

  \cp -f "${__CURRENT_DIR}/setup_files/synopsys_setup_ant.sh" "${COMPONENT_DIR}/components"
